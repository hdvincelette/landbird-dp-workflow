...
#   readxl::read_excel(
#     "mdJSONdictio_Dictionary_Template_v1.xlsx",
#     sheet = 3,
#     col_names = FALSE
#   ) ,
#   1
...
for (a in 1:length(warning.list)) {
  ...
  my.dxnry<- extract.mdJSON(x=x)
  
  new.dictionary <-
    modify.mdJSON(x = my.dxnry,
                  how = "add_attribute",
                  codeName = "WingArea")
  ...
  test[["data"]][[1]][["attributes"]][["json"]] <-
    rjson::toJSON(new.dictionary)
  
  
  new.json = rjson::toJSON(x = test)
